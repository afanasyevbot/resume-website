...
function PhoneShell({ children }: { children: React.ReactNode }) {
  return (
    <div
      className="relative overflow-hidden rounded-[28px] sm:rounded-[32px] border border-[rgba(60,60,67,0.12)] bg-[#faf8f6] shadow-[0_16px_48px_rgba(60,40,70,0.12)] min-h-[420px] sm:min-h-[480px] flex flex-col"
      style={{
        backgroundImage:
