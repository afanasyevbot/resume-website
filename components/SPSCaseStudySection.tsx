...
export default function SPSCaseStudySection() {
  return (
    <section id="sps-ai-workflow" className="section-divider text-center">
      <div className="mx-auto max-w-[62ch]">
        <div className="mb-8 sm:mb-10">
          <p className="text-[11px] font-medium uppercase tracking-[0.18em] mb-3 text-ghost">SPS Commerce</p>
          <h2 className="font-display text-[26px] sm:text-[34px] lg:text-[38px] font-medium leading-[1.15] tracking-[-0.02em] max-w-[28ch] mx-auto text-ink text-balance">
            {spsCaseStudy.title}
          </h2>
        </div>

        <article className="card card-lift p-7 sm:p-9 text-left">
